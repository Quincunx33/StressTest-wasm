...
function __wbg_adapter_42(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3d76925219ff6e6e(arg0, arg1);
}

function __wbg_adapter_45(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9faf3de2375df86d(arg0, arg1);
}

function __wbg_adapter_48(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h077c75f9772a64f9(arg0, arg1, addHeapObject(arg2));
}
...
* @param {number | undefined} timeout_ms
...
* @param {number | undefined} [rate_limit]
* @param {number | undefined} [circuit_threshold]
* @param {number | undefined} [retry_attempts]
* @param {boolean | undefined} [use_user_agent_rotation]
* @param {boolean | undefined} [use_waf_bypass]
* @param {boolean | undefined} [waf_cache_buster]
* @param {boolean | undefined} [waf_xff_rotation]
* @param {boolean | undefined} [waf_random_headers]
* @param {number | undefined} [rate_limit_max_wait_ms]
* @param {number | undefined} [retry_base_delay_ms]
* @param {number | undefined} [retry_max_delay_ms]
* @param {bigint | undefined} [circuit_timeout_ms]
* @param {number | undefined} [circuit_window_size]
* @param {bigint | undefined} [circuit_window_ms]
* @param {boolean | undefined} [reset_window_on_probe_success]
* @param {boolean | undefined} [enable_templating]
* @returns {Promise<any>}
*/
export function run_stress_test(url, total_requests, concurrency, method, headers_json, body, timeout_ms, follow_redirects, load_pattern, expected_status, expected_text, custom_script, progress_callback, rate_limit, circuit_threshold, retry_attempts, use_user_agent_rotation, use_waf_bypass, waf_cache_buster, waf_xff_rotation, waf_random_headers, rate_limit_max_wait_ms, retry_base_delay_ms, retry_max_delay_ms, circuit_timeout_ms, circuit_window_size, circuit_window_ms, reset_window_on_probe_success, enable_templating) {
    ...
    const ret = wasm.run_stress_test(ptr0, len0, total_requests, concurrency, ptr1, len1, ptr2, len2, ptr3, len3, !isLikeNone(timeout_ms), isLikeNone(timeout_ms) ? 0 : timeout_ms, follow_redirects, ptr4, len4, expected_status, ptr5, len5, ptr6, len6, addHeapObject(progress_callback), !isLikeNone(rate_limit), isLikeNone(rate_limit) ? 0 : rate_limit, !isLikeNone(circuit_threshold), isLikeNone(circuit_threshold) ? 0 : circuit_threshold, !isLikeNone(retry_attempts), isLikeNone(retry_attempts) ? 0 : retry_attempts, isLikeNone(use_user_agent_rotation) ? 0xFFFFFF : use_user_agent_rotation ? 1 : 0, isLikeNone(use_waf_bypass) ? 0xFFFFFF : use_waf_bypass ? 1 : 0, isLikeNone(waf_cache_buster) ? 0xFFFFFF : waf_cache_buster ? 1 : 0, isLikeNone(waf_xff_rotation) ? 0xFFFFFF : waf_xff_rotation ? 1 : 0, isLikeNone(waf_random_headers) ? 0xFFFFFF : waf_random_headers ? 1 : 0, !isLikeNone(rate_limit_max_wait_ms), isLikeNone(rate_limit_max_wait_ms) ? 0 : rate_limit_max_wait_ms, !isLikeNone(retry_base_delay_ms), isLikeNone(retry_base_delay_ms) ? 0 : retry_base_delay_ms, !isLikeNone(retry_max_delay_ms), isLikeNone(retry_max_delay_ms) ? 0 : retry_max_delay_ms, !isLikeNone(circuit_timeout_ms), isLikeNone(circuit_timeout_ms) ? BigInt(0) : circuit_timeout_ms, !isLikeNone(circuit_window_size), isLikeNone(circuit_window_size) ? 0 : circuit_window_size, !isLikeNone(circuit_window_ms), isLikeNone(circuit_window_ms) ? BigInt(0) : circuit_window_ms, isLikeNone(reset_window_on_probe_success) ? 0xFFFFFF : reset_window_on_probe_success ? 1 : 0, isLikeNone(enable_templating) ? 0xFFFFFF : enable_templating ? 1 : 0);
...
export function validate_config(total_requests, concurrency) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.validate_config(retptr, total_requests, concurrency);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export function metrics_snapshot_json(snapshot) {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.metrics_snapshot_json(retptr, addHeapObject(snapshot));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
...
export function register_interceptor(name, js_fn) {
    ...
    const len0 = WASM_VECTOR_LEN;
    wasm.register_interceptor(ptr0, len0, addHeapObject(js_fn));
}
...
function __wbg_adapter_148(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h6beaed761ce3af63(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const DistributedTestFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_distributedtest_free(ptr >>> 0));
/**
*/
export class DistributedTest {
    ...
    free() {
        ...
        wasm.__wbg_distributedtest_free(ptr);
    }
    /**
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_aborted_a00baf4a48da2629 = function(arg0) {
    ...
    imports.wbg.__wbg_race_107f0952cdba035b = function(arg0) {
    ...
    imports.wbg.__wbindgen_closure_wrapper237 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 44, __wbg_adapter_42);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper348 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 76, __wbg_adapter_45);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper540 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 96, __wbg_adapter_48);
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('stress_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
